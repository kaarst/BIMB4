...
class BestelOrderType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ;
        $builder
            ->add('bestelnummer',IntegerType::class) //naam is b.v. een attribuut of variabele van klant
        ;
        $builder
            ->add('artikelnummers', TextType::class) //naam is b.v. een attribuut of variabele van klant
        ;
        $builder
            ->add('bestelhoeveelheid', IntegerType::class) //naam is b.v. een attribuut of variabele van klant
        ;
